...
feature_row:
  ...
  - image_path: /assets/images/documentation-icon.png
    ...
    title: "Placeholder 2"
    excerpt: "This is some sample content that goes here with **Markdown** formatting."
    url: "/portfolio/developer-guide-samples.md"
    btn_label: "Read More"
...
<!-- Notes -->
<!-- 
Later, break this into more sections- user manuals, procedures, api reference documentation, etc. Make sure to drag down PDFs of all content

Projects can be another page

To host the site locally, run `bundle exec jekyll serve` and navigate to http://localhost:4000/.
